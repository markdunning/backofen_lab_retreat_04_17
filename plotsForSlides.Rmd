...
png("images/skills-feedback.png",width=1200,height=800)


skills <- select(feedback, Experimental.Design:Software.development) %>% gather
ggplot(skills, aes(x=value)) + geom_bar(fill="steelblue") + facet_wrap(~key)
